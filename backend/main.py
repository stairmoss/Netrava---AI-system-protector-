...
def api_chat(req: ChatRequest):
    ...
    # Custom rule mappings for known scam vectors
    if "arrest" in msg or "police" in msg or "cbi" in msg or "customs" in msg or "narcotics" in msg:
        ...
        reply = (
            ...
            "Fraudsters lure victims with promises of earning Rs.3,000 to Rs.8,000 daily just by rating hotels, liking YouTube videos, or reviewing maps.\n\n"
            "**How it works:**\n"
            "1. They pay you a small initial sum (e.g. Rs.150) to build trust.\n"
        ...
        reply = (
            "**Malware and Ransomware Shield Info**\n\n"
